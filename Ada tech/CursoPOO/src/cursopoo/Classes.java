...
public class Classes {
    ...
    //            System.out.println(cachorro1.getNome()); / mostrar nome do cachorro1
    //            System.out.println(cachorro1.getPeso()); / mostrar peso do cachorro1
        ...
        //P/ realizar uma ação
        cachorro1.soar(); //variavel de referencia do objeto . método();
